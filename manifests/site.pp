...
node /^analytics10(1[1-9]|20)\.eqiad\.wmnet/ inherits analytics_basenode {
	include role::analytics::hadoop::worker
}

# analytics1021 and analytics1022 are Kafka Brokers
node "analytics1021.eqiad.wmnet", "analytics1022.eqiad.wmnet" inherits analytics_basenode {
	include role::analytics::kafka
}

# analytics1023, analytics1024 and anlytics1025 are Zookeeper Servers
node "analytics1023.eqiad.wmnet", "analytics1024.eqiad.wmnet", "analytics1025.eqiad.wmnet" inherits analytics_basenode {
	include role::analytics::zookeeper
}

# analytics1026 does not yet have a role
node "analytics1026.eqiad.wmnet" inherits analytics_basenode {
	include role::analytics
}

# analytics1027 hosts front end web interfaces
# (e.g. Hue, Oozie, Storm UI, etc.)
node "analytics1027.eqiad.wmnet" inherits analytics_basenode {
